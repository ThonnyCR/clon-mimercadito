            ...
            <div className="container">
                ...
                <div className="d-flex justify-content-center align-items-center">
                        <div className="slider-card">
                            ...
                            <div className="slider-card-image"><img src="\assets\img\cardSlider5\amen.png" className="img-fluid" /></div>
                    ...
                    <div className="d-flex justify-content-center align-items-center">
                        <div className="slider-card">
                            ...
                            <div className="slider-card-image"><img src="\assets\img\cardSlider5\drink.png" className="img-fluid" /></div>
