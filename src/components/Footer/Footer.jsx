                ...
                <div className='container justify-content-center container_m'>
                    <div className="row d-flex pt-5 columnf1">
                        <div id='columnf1' className='col-sm-12 col-md-12 col-lg-6 col-xl-3 columnf1'>
                            <img src="\assets\img\footer\Recurso 3@ax.png " alt="Mi mercadito" className='img_m img-fluid' />
                            <h3 className='txt '>
                                <FormattedMessage
                        ...
                        <div id='columnf4' className="col-sm-12 col-md-12 col-lg-6 col-xl-3">
                            ...
                            <h3 className='txt'><span><img src="\assets\img\footer\contact-us1.png" alt="Correo" className='txt_c' /></span>contacto@mimercadito.cr</h3>
                            <h3 className='txt'><span><img src="\assets\img\footer\phone.png" alt="Teleono" className='txt_c' /></span>2234-6735</h3>
                            <h3 className='txt'><span><img src="\assets\img\footer\wp.png" alt="Whatssap" className='txt_c' /></span>8913-9439</h3>
                            <div><img src="\assets\img\footer\facebook copia.png" alt="Correo" className='img_c' /><img src="\assets\img\footer\instagram.png" alt="Correo" className='' /></div>
                        </div>
                        <div id='columnf5' className="col-sm-12 col-md-12 col-lg-12 text-center d-flex justify-content-center">
                            <h3 className='txt'><span><img src="\assets\img\footer\tarjeta1.png" alt="Correo" className='img_t' /></span></h3>
                            <h3 className='txt'><span><img src="\assets\img\footer\tarjeta2.png" alt="Correo" className='img_t' /></span></h3>
                            <h3 className='txt'><span><img src="\assets\img\footer\tarjeta3.png" alt="Correo" className='img_t' /></span></h3>
                            <h3 className='txt'><span><img src="\assets\img\footer\tarjeta4.png" alt="Correo" className='img_t' /></span></h3>
                            <h3 className='txt'><span><img src="\assets\img\footer\tarjeta5.png" alt="Correo" className='img_t' /></span></h3>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div className='row'>
                        ...
                        <div className='col-lg-2 col-sm-12 col-md-12'>
                            <p className='footer_p2'>
                                ...
                                />
                                <span><img src="\assets\img\footer\decimo.png" alt="Decimo" className='img-fluid img_d' /></span></p>
                        </div>
                    </div>
